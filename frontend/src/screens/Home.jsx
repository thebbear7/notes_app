...
const Home = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`https://wazirone-assignment-147bfu55d-safwannazir911s-projects.vercel.app/api/notes`)
      .then(response => {
  ...
  const handleSaveChanges = () => {
    ...
    if (editNote) {
      ...
      axios.put(`https://wazirone-assignment-147bfu55d-safwannazir911s-projects.vercel.app/api/notes/${editNote._id}`, formData)
        .then(() => {
      ...
      axios.post('https://wazirone-assignment-147bfu55d-safwannazir911s-projects.vercel.app/api/notes', formData)
        .then(() => {
          // Reset state and close the modal
          // Set success message
  ...
  const handlePin = (note) => {
    ...
    axios.put(`https://wazirone-assignment-147bfu55d-safwannazir911s-projects.vercel.app/api/notes/${note._id}`, {
      pinned: !note.pinned,
    })
      .then(response => {
  ...
  const handleDelete = (noteId) => {
    ...
    axios.delete(`https://wazirone-assignment-147bfu55d-safwannazir911s-projects.vercel.app/api/notes/${noteId}`)
      .then(() => {
